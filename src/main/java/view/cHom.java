...
public class cHom extends javax.swing.JFrame {
    ...
    double getR(){
        int b = Integer.parseInt(bath.getText());
    ...
    void loadHome(){
        String adrs = nCalle.getText();
        double r = getR();
        //Muestra el resultado
        res.setText(String.valueOf(r));
        //llama los valores para asignarlo a la db
        idHome.setText(String.valueOf(model.ModelConstruction.LoadHome(adrs,r)));
